...
import { addNewFerfarYadiFormInfo, geFerFarYadiList, getAnnuKramank, getFerFarYadiDetailById, getYearList, searchFerFarYadi, softDeleteFerfarYadi, updateFerfarYadi } from "../../services/main/ferfar-yadi.service";
