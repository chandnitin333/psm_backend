...
ALTER TABLE othertax ADD COLUMN DELETED_AT DATETIME DEFAULT NULL NULL;

ALTER TABLE createothertax ADD COLUMN DELETED_AT DATETIME DEFAULT NULL NULL;
...
ALTER TABLE `magilbakinew` ADD COLUMN `DELETED_AT` DATETIME DEFAULT NULL;
